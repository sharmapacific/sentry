...
// this in the future becuase all callbacks _should_ be allowed to be
...
/**
 * Recieves an organization object and should return a React node.
 */
...
type AnalyticsTrackEvent = (opts: {
  ...
  eventKey: string;
  /**
   * The Englsih string used as the name of the event.
   */
  eventName: string;
  /**
...
type MetricsEvent = (
  ...
  value: number,
  /**
   * An additioanl tags object
   */
  tags?: object
) => void;

/**
 * Provedes additional setting c.onfigurations
 *
...
type SidebarItemLabelHook = (opts: {
  /**
   * The key of the item label currently being rendererd.
   */
  id: string;
}) => React.ReactNode;
